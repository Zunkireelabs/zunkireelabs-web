...
export default [
  {
    ...
    expandedContent: "<div class=\"container-custom py-12 md:py-20\">\n  <section class=\"gap-2\">\n    <h2 class=\"text-3xl md:text-4xl lg:text-5xl font-normal text-gray-900\">References</h2>\n    <div class=\"text-lg md:text-xl text-gray-600 leading-relaxed max-w-2xl\"><p class=\"text-gray-600 leading-relaxed\"><a href=\"https://zunkireelabs.com/compare/zunkiree-vs-algolia/\" class=\"text-zunkiree-600 hover:underline\">Zunkiree Search vs Algolia | Search Comparison</a></p></div>\n  </section>\n</div>",
    faqs: [
      /* SEOAI:FAQ:START */
  ...
  },
  {
    ...
    expandedContent: "<div class=\"container-custom py-12 md:py-20\">\n  <section class=\"gap-2\">\n    <h2 class=\"text-3xl md:text-4xl lg:text-5xl font-normal text-gray-900\">References</h2>\n    <div class=\"text-lg md:text-xl text-gray-600 leading-relaxed max-w-2xl\"><p class=\"text-gray-600 leading-relaxed\"><a href=\"https://zunkireelabs.com/compare/zunkiree-vs-elasticsearch/\" class=\"text-zunkiree-600 hover:underline\">Zunkiree Search vs Elasticsearch | Search Comparison</a>\n<a href=\"https://zunkireelabs.com/products/search/\" class=\"text-zunkiree-600 hover:underline\">AI-Native Search &amp; Interaction Solutions</a>\n<a href=\"https://www.elastic.co/enterprise-search\" class=\"text-zunkiree-600 hover:underline\">The open source engine for high-performance search, ...</a></p></div>\n  </section>\n</div>"
  },
  {
