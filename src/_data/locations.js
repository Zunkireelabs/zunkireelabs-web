...
Working with a Kathmandu-based AI company offers distinct advantages: competitive rates compared to US or European firms, a large pool of English-speaking engineers, and time zone overlap with both Asian and European markets.`,
    ...
    // Map embed
    mapEmbed: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d113032.64415098942!2d85.25610059726563!3d27.70895544000484!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb198a307baabf%3A0xb5137c1bf18db1ea!2sKathmandu%2044600%2C%20Nepal!5e0!3m2!1sen!2sus!4v1680000000000!5m2!1sen!2sus",
    ...
    nearbyCities: ["lalitpur", "bhaktapur", "pokhara"],
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "Yes, approximately 60% of our clients are international companies from the US, Europe, and Asia. We've built remote collaboration processes that ensure seamless communication across time zones."
      },
      {
        question: "What are the advantages of working with a Kathmandu AI company?",
        answer: "Working with our Kathmandu team offers cost advantages of 40-60% compared to US firms, access to a growing pool of AI talent, English-speaking engineers, and time zone overlap with both European and Asian markets."
      },
      {
        question: "Can I visit your Kathmandu office?",
        answer: "Yes, we welcome client visits. Please contact us to schedule a meeting at our Kathmandu office. We can also arrange virtual office tours for international clients."
      },
      {
    ...
    services: {
      "ai-development": {
        ...
        highlights: [
          "15+ AI engineers based in Kathmandu",
      ...
      "ai-customer-experience": {
        ...
        highlights: [
          "Multilingual support including Nepali and English",
    ...
    expandedContent: "<section class=\"py-12 md:py-20\">\n  <div class=\"max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8\">\n    <div class=\"mb-8 last:mb-0\">\n      <h3 class=\"text-[19px] md:text-[22px] font-normal text-gray-900 mb-3\">Web Development Services Comparison</h3>\n      <p class=\"text-gray-600 leading-relaxed\">When considering web development services, it’s essential to understand the key differences and similarities between various options available in Kathmandu. Below is a comparison of our web development services against other potential web development solutions.</p>\n    </div>\n    <div class=\"mb-8 last:mb-0\">\n      <h3 class=\"text-[19px] md:text-[22px] font-normal text-gray-900 mb-3\">Our Services vs. Others</h3>\n      <p class=\"text-gray-600 leading-relaxed\">Here's a breakdown of how our web development services stack up against typical offerings in the market.</p>\n    </div>\n    <div class=\"mb-8 last:mb-0\">\n      <h3 class=\"text-[19px] md:text-[22px] font-normal text-gray-900 mb-3\">Comparison Table</h3>\n      <div class=\"text-gray-600 leading-relaxed\"><div class=\"mb-10 overflow-hidden rounded-lg border border-gray-200\"><table class=\"w-full text-sm\"><thead class=\"bg-gray-50\"><tr class=\"bg-gray-100\"><th class=\"px-4 py-3 text-left font-medium text-gray-900\">Features</th><th class=\"px-4 py-3 text-left font-medium text-gray-900\">Our Services</th><th class=\"px-4 py-3 text-left font-medium text-gray-900\">Other Services</th></tr></thead><tbody class=\"divide-y divide-gray-200\"><tr><td class=\"px-4 py-3 font-medium text-gray-900\">Page Load Speed</td><td class=\"px-4 py-3 text-gray-600\">Sub-second</td><td class=\"px-4 py-3 text-gray-600\">Varies</td></tr><tr><td class=\"px-4 py-3 font-medium text-gray-900\">Frameworks Used</td><td class=\"px-4 py-3 text-gray-600\">Next.js, Eleventy, Tailwind CSS</td><td class=\"px-4 py-3 text-gray-600\">Typically limited options</td></tr><tr><td class=\"px-4 py-3 font-medium text-gray-900\">Mobile Design</td><td class=\"px-4 py-3 text-gray-600\">Mobile-first responsive design</td><td class=\"px-4 py-3 text-gray-600\">Responsive, may not prioritize mobile</td></tr><tr><td class=\"px-4 py-3 font-medium text-gray-900\">SEO Optimization</td><td class=\"px-4 py-3 text-gray-600\">Built-in SEO and AEO</td><td class=\"px-4 py-3 text-gray-600\">Varies, often requires addons</td></tr><tr><td class=\"px-4 py-3 font-medium text-gray-900\">Ongoing Support</td><td class=\"px-4 py-3 text-gray-600\">Yes</td><td class=\"px-4 py-3 text-gray-600\">Limited or additional cost</td></tr></tbody></table></div></div>\n    </div>\n  </div>\n</section>"
      ...
      "custom-software": {
        ...
        highlights: [
          "Full-stack development team in Kathmandu",
    ...
    expandedContent: "<div class=\"container-custom py-12 md:py-20\">\n  <section class=\"gap-2\">\n    <h2 class=\"text-[24px] md:text-[28px] font-normal text-gray-900\">Comparing Mobile App Development Options in Kathmandu</h2>\n    <div class=\"text-lg md:text-xl text-gray-600 leading-relaxed max-w-2xl\"><p class=\"text-lg md:text-xl text-gray-600 leading-relaxed max-w-2xl\">When considering mobile app development in Kathmandu, several companies offer differing capabilities and expertise. It's crucial to understand their strengths to make an informed decision that best suits your project's needs. Our seasoned team specializes in native and cross-platform mobile app solutions tailored to the unique requirements of your business.</p><div class=\"overflow-x-auto\"><table class=\"w-full text-sm\"><thead><tr><th class=\"px-4 py-3 text-left font-medium text-gray-900\">Feature</th><th class=\"px-4 py-3 text-left font-medium text-gray-900\">Alternative</th><th class=\"px-4 py-3 text-left font-medium text-gray-900\">This Option</th></tr></thead><tbody><tr><td class=\"px-4 py-3 font-medium text-gray-900\">Development Approach</td><td class=\"px-4 py-3 font-medium text-gray-900\">Focuses primarily on either native or cross-platform without providing extensive integrations.</td><td class=\"px-4 py-3 font-medium text-gray-900\">Native iOS and Android development alongside cross-platform using React Native/Flutter</td></tr><tr><td class=\"px-4 py-3 font-medium text-gray-900\">Backend Integration</td><td class=\"px-4 py-3 font-medium text-gray-900\">Limited backend capabilities that may require additional development phases.</td><td class=\"px-4 py-3 font-medium text-gray-900\">Seamless backend API integration that enhances app functionality</td></tr><tr><td class=\"px-4 py-3 font-medium text-gray-900\">App Store Optimization</td><td class=\"px-4 py-3 font-medium text-gray-900\">Basic launch support but lacks in-depth optimization services.</td><td class=\"px-4 py-3 font-medium text-gray-900\">Comprehensive app store optimization and launch strategies</td></tr></tbody></table></div></div>\n  </section>\n</div>"
  },
      "aeo-seo": {
  ...
  },
  {
    ...
    faqs: [
      {
        question: "Can you work with clients in Pokhara?",
        answer: "Yes, we work with Pokhara clients remotely and can travel for key meetings. Our experience with international remote clients means seamless collaboration regardless of location."
      },
      {
