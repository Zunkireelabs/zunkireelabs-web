...
export default [
  ...
  },
  {
    ...
    relatedService: "ai-development",
    category: "AI Architecture",
    expandedContent: "<div class=\"py-12 md:py-20\">\n  <section class=\"gap-2\">\n    <h2 class=\"font-normal text-gray-900\">Comparing RX Retrieval Systems: Zunkiree Labs vs. Alternatives</h2>\n    <div class=\"text-lg md:text-xl text-gray-600 leading-relaxed max-w-2xl\"><p>When evaluating RX retrieval systems, it's crucial to understand how Zunkiree Labs' approach stacks up against other players in the market. While many companies utilize fundamental techniques like keyword and semantic search, Zunkiree Labs stands out due to its focus on advanced reranking, query expansion, and metadata filtering strategies that enhance retrieval accuracy and, consequently, AI performance.</p><table><thead><tr><th>Feature</th><th>Alternative</th><th>Zunkiree Labs</th></tr></thead><tbody><tr><td>Search Techniques</td><td>May primarily rely on basic keyword searches without advanced techniques</td><td>Uses keyword search (BM25) and semantic search (vector similarity)</td></tr><tr><td>Retrieval Quality Enhancement</td><td>Often lacks robust methods for enhancing retrieval quality</td><td>Implements reranking and query expansion for improved accuracy</td></tr></tbody></table></div>\n  </section>\n</div>"
  },
  {
    id: "inference",
    term: "Inference",
